...
if ( ! function_exists( 'quest_widgets_init' ) ):
	...
	function quest_widgets_init() {
		...
		// sidebars added by Giovanni
		//Register Footer WIdgets
		register_sidebar( array(
			'name'          => __( 'Header Widget', 'quest' ),
			'id'            => 'header-widget',
			'before_widget' => '<div class="col-md-' . $span . ' %2$s" id="%1$s">',
			'after_widget'  => "</div>\n",
			'before_title'  => '<h1>',
			'after_title'   => "</h1>\n"
		) );
		register_sidebar( array(
			'name'          => __( 'Sub-header Widget', 'quest' ),
			'id'            => 'sub-header-widget',
